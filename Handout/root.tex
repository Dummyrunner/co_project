...
% MYTHINGS
\usepackage{amssymb,amsmath, amsfonts,color,bbm}
\usepackage[ruled, vlined]{algorithm2e}

% packages for matlab listings
% https://tex.stackexchange.com/questions/75116/what-can-i-use-to-typeset-matlab-code-in-my-document
\usepackage[T1]{fontenc}
\usepackage{bigfoot} % to allow verbatim in footnote
\usepackage[numbered,mlscaleinline=true]{matlab-prettifier}
...
\newcommand{\xbark}{\xbar_k}
\newcommand{\xnullbar}{\xbar_0}
\newcommand{\ubar}{\bar{u}}
\newcommand{\ubark}{\ubar_k}
...
\newcommand{\normmax}[1]{\ind{\left\lVert#1\right\rVert}{max}}
\newcommand{\boundu}{\ind{l}{u}}
\newcommand{\boundx}{\ind{l}{x}}
...
\newcommand{\mpc}{MPC}
\newcommand{\mpclong}{Model Predictive Control}
...
\begin{thebibliography}{99}
	  ...
	  \bibitem{EX} Jack Heider, {\em Quadratic programming}  2015: online, \verb|https://optimization.mccormick.northwestern.edu|\\ \verb|/index.php/Quadratic_programming|.
\end{thebibliography}
